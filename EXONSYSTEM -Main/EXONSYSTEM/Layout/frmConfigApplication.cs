...
namespace EXONSYSTEM.Layout
{
    public partial class frmConfigApplication : MetroForm
    {
        ...
        void m_oWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            //string DBUser = Properties.Resources.DATABASE_USER;
            //int portSupervisor = Int32.Parse(ConfigurationManager.AppSettings["Port"].ToString());
            //int portDB = Convert.ToInt32(Properties.Resources.DATABASE_PORT);
            //string PsDB = Properties.Resources.DATABASE_PASS;
            //string Ip_Db = Properties.Resources.IP_DB;
            //string ip_super = ConfigurationManager.AppSettings["IP"].ToString();
            ...
            if (ValidateChildren(ValidationConstraints.Enabled))
            {
                ...
                {
                    //khai bao database
                    //string servername = Properties.Resources.SERVER_NAME;
              
                    //ca.Database = new IPConfig(servername, Convert.ToInt32(Properties.Resources.DATABASE_PORT));
                    //ca.DBName = Properties.Resources.DATABASE_NAME;
                    //ca.UsernameDB = Properties.Resources.DATABASE_USER;
                    //ca.PasswordDB = Properties.Resources.DATABASE_PASS;
                    ...
                    //{
                        ...
                        if (Controllers.Instance.HandleCheckDB( out rEC))
                        {
                            s("lbDB");
                        ...
                        else
                        {
                            ...
                            Controllers.Instance.ShowNotificationForm(Constant.TYPE_NOTIFICATION_WARNING, Properties.Resources.MSG_GUI_0061 +"\n"+ rEC.Message, this);
                        m_oWorker.ReportProgress(50);
                       // check = 1;
                        }
                    //}
                ...
                {
                    Controllers.Instance.ShowNotificationForm(Constant.TYPE_NOTIFICATION_WARNING, "Không xác định được máy chủ!", this);
                    Application.Exit();
                }
