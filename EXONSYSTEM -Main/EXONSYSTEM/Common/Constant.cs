...
namespace EXONSYSTEM.Common
{
	public static class Constant
	{
		...
		public static int NUMBER_QUESTIONS_PER_ROW =8;
		...
		public static string STR_STATUS_READY = string.Format("{0}: {1}", STATUS_READY, Properties.Resources.MSG_MESS_0046);
		...
		public static Color FORCECOLOR_LABEL_TIMER_5_MINUTES = Color.FromArgb(255, 0, 0);
		public static Color FORCECOLOR_LABEL_TIMER_1_MINUTE = Color.FromArgb(160, 0, 0);
		...
		public static Size SIZE_BUTTON_QUESTION = new Size(80, 30);
		public static int WIDTH_QUESTION_BUTTON = 50;
